    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 flex h-screen overflow-hidden DashboardLayout_container">
      ...
      <div className={`${sidebarClasses} no-print`}>
        ...
        <nav className="flex-1 overflow-y-auto px-4 space-y-2">
          ...
          <div className="space-y-1">
            ...
            {(isLeadsMenuOpen || isSidebarCollapsed) && (
              ...
              >
                ...
                {/* Reminders Item (Day 31) */}
                <button
                  onClick={() => navigate("/dashboard/crm/reminders")}
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/crm/reminders")
                      ? "text-indigo-600 bg-indigo-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
          ...
          <button
            onClick={() => navigate("/dashboard/crm/expenses")}
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition-all ${
              isActive("/dashboard/crm/expenses")
                ? "bg-indigo-50 text-indigo-700"
                : "text-slate-500 hover:bg-slate-50 hover:text-slate-900"
            } ${isSidebarCollapsed ? "justify-center px-2" : ""}`}
          ...
          <div className="space-y-1">
            ...
            >
              <div className="flex items-center gap-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={`h-5 w-5 flex-shrink-0 ${isReportsActive && isSidebarCollapsed ? "text-indigo-600" : ""}`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            {(isReportsMenuOpen || isSidebarCollapsed) && (
              <div
                className={`${isSidebarCollapsed ? "space-y-2" : "pl-11 space-y-1"}`}
              >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/reports/vat")
                      ? "text-indigo-600 bg-indigo-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
                  title="VAT Summary"
          ...
          <div className="space-y-1">
            <button
              ...
              title={isSidebarCollapsed ? "HR & Payroll" : ""}
            >
              <div className="flex items-center gap-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={`h-5 w-5 flex-shrink-0 ${location.pathname.includes("/dashboard/hr") && isSidebarCollapsed ? "text-violet-600" : ""}`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                {!isSidebarCollapsed && <span>HR & Payroll</span>}
              </div>
              {!isSidebarCollapsed && (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={`h-4 w-4 transition-transform duration-200 ${isHrMenuOpen ? "rotate-180" : ""}`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            {(isHrMenuOpen || isSidebarCollapsed) && (
              ...
              >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/hr/employees")
                      ? "text-violet-600 bg-violet-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
                  title="Employees"
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/hr/employees/create")
                      ? "text-violet-600 bg-violet-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
                  title="Add Employee"
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/hr/departments")
                      ? "text-violet-600 bg-violet-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
                  title="Departments"
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/hr/attendance")
                      ? "text-violet-600 bg-violet-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
                ...
                {/* Salary Advance Link */}
                <button
                  onClick={() => navigate("/dashboard/hr/salary-advance")}
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/hr/salary-advance")
                      ? "text-violet-600 bg-violet-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
          ...
          <div className="space-y-1">
            ...
            {(isAppointmentsMenuOpen || isSidebarCollapsed) && (
              ...
              >
                ...
                {/* Staff Item */}
                <button
                  onClick={() => navigate("/dashboard/appointments/staff")}
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/appointments/staff")
                      ? "text-indigo-600 bg-indigo-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
                ...
                <button
                  onClick={() =>
                    navigate("/dashboard/appointments/availability")
                  }
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/appointments/availability")
                      ? "text-indigo-600 bg-indigo-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/appointments/book")
                      ? "text-indigo-600 bg-indigo-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2 py-2 rounded-lg text-sm font-medium transition-all ${
                    isActive("/dashboard/appointments/list")
                      ? "text-indigo-600 bg-indigo-50"
                      : "text-slate-500 hover:text-slate-900 hover:bg-slate-50"
                  } ${isSidebarCollapsed ? "justify-center p-2" : "px-3"}`}
                  title="Booking List"
