...
const Attendance = () => {
  ...
  const handleExportCSV = async () => {
    try {
      let url = `/api/hr/attendance/export_csv/?month=${selectedMonth}&year=${selectedYear}`;
      if (searchMonthly) url += `&search=${encodeURIComponent(searchMonthly)}`;
      if (deptMonthly) url += `&department=${deptMonthly}`;
      if (roleMonthly) url += `&designation=${roleMonthly}`;
      ...
      a.href = downloadUrl;
      a.download = `attendance_history_${selectedYear}_${selectedMonth}.csv`;
  ...
  return (
    <>
          ...
          {viewMode === "DAILY" ? (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm grid grid-cols-1 md:grid-cols-6 gap-4 items-end">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="w-full bg-emerald-50 hover:bg-emerald-100 text-emerald-600 py-2 rounded-xl text-xs font-bold transition-all border border-emerald-100 flex items-center justify-center gap-1"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <button
                    ...
                    className="w-full bg-blue-50 hover:bg-blue-100 text-blue-600 py-2 rounded-xl text-xs font-bold transition-all border border-blue-100 flex items-center justify-center gap-1"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-3.5 w-3.5"
              ...
              <div
                ...
                className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 overflow-hidden border border-slate-100 p-1"
              >
                {/* Print Header (Only visible in print) */}
                <div className="hidden print:block mb-8 text-center p-6 border-b-2 border-slate-200">
      ...
      @media print {
        ...
        #attendance-monthly-report, #attendance-monthly-report * {
        ...
        span { color: white !important; -webkit-print-color-adjust: exact; }
      }
    `,
        }}
      />
